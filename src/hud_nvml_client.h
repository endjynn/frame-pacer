...
FRAME_PACER_NVML_INTERNAL bool frame_pacer_nvml_client_acquire(
    unsigned int process_id, const char *pci_bus_id);
FRAME_PACER_NVML_INTERNAL void frame_pacer_nvml_client_release(void);
FRAME_PACER_NVML_INTERNAL bool frame_pacer_nvml_client_snapshot(
...
FRAME_PACER_NVML_INTERNAL void frame_pacer_nvml_client_test_publish(
