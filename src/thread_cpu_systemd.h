...
struct frame_pacer_systemd {
    ...
    int (*message_open_container)(struct sd_bus_message *, char,
                                  const char *);
    ...
    int (*bus_call)(struct sd_bus *, struct sd_bus_message *, uint64_t,
                    void *, struct sd_bus_message **);
    void (*error_free)(void *);
};

__attribute__((visibility("hidden")))
bool frame_pacer_systemd_open(struct frame_pacer_systemd *);
__attribute__((visibility("hidden")))
void frame_pacer_systemd_close(struct frame_pacer_systemd *);
__attribute__((visibility("hidden")))
bool frame_pacer_systemd_start_scope(struct frame_pacer_systemd *,
                                     const char *name, pid_t process_id);
__attribute__((visibility("hidden")))
bool frame_pacer_systemd_start_service(struct frame_pacer_systemd *,
