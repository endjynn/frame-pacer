...
static inline bool
frame_pacer_runtime_log_active(const struct frame_pacer_runtime_log *log)
{
...
FRAME_PACER_INTERNAL bool
frame_pacer_runtime_log_activate(struct frame_pacer_runtime_log *,
                                 const char *filename_prefix,
                                 const char *startup_message);
FRAME_PACER_INTERNAL void
frame_pacer_runtime_log_vwrite(struct frame_pacer_runtime_log *, const char *,
                               va_list);
FRAME_PACER_INTERNAL uint64_t
frame_pacer_runtime_log_bytes(struct frame_pacer_runtime_log *);
FRAME_PACER_INTERNAL void
frame_pacer_runtime_log_close(struct frame_pacer_runtime_log *);
